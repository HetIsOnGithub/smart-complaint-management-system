    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Technical', 'Technical'), ('Electrical', 'Electrical'), ('Network', 'Network'), ('Maintenance', 'Maintenance'), ('Cleanliness', 'Cleanliness'), ('Security', 'Security'), ('Academic', 'Academic'), ('Administrative', 'Administrative'), ('Other', 'Other')], max_length=50)),
